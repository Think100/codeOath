...
| Fix a messy existing project | [triggers.md](resources/triggers.md#already-have-a-project) |
| Understand the principles | [philosophy.md](resources/philosophy.md) |


## Core Path

The three stages. Read them when you need them, not all at once.

| Document | Stage | What it covers | Level |
|---|---|---|---|
| [start.md](start.md) | 1: Start | Project setup, AGENTS.md, todo.md | Beginner |
| [grow.md](grow.md) | 2: Grow | Domain/adapters, decisions, ports, testing | Intermediate |
| [enforce.md](enforce.md) | 3: Enforce | Linters, import checks, CI/CD, branching | Advanced |
| [ai-workflow.md](ai-workflow.md) | Any stage | Multi-perspective reviews, session habits, reusable agents | All |
...
| [ports-and-adapters.md](resources/ports-and-adapters.md) | The architecture pattern behind Stage 2 |
| [alternatives.md](resources/alternatives.md) | Feature-sliced, modular monolith, vertical slices |
